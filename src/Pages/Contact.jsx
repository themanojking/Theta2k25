...
export const Contact = () => {
    ...
    return (
        <div>
                        ...
                        <div className="bg-white border-4  border-[#92553D] rounded-lg shadow-lg">
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-center gap-8 py-6">
                                <div className="flex items-center">
                                    ...
                                    <p className="font-medium tracking-wide">sastraedu@gmail.com</p>
                                </div>
                                <div className="flex items-center">
                                    <i className="bx bx-phone-call text-2xl text-gray-700 mr-2" />
                                    <p className="font-medium tracking-wide">+91 9080480913</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Google Map Section */}
           <div className='px-5 '>
           <div className="mx-auto mt-10 md:mt-16  md:px-0 max-w-7xl h-96 md:h-[35rem] border-2 border-[#92553D]  rounded-xl shadow-md">
                <iframe
