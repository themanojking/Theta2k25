...
const data = [
  ...
  },
  {
    tittle: '\n EMULSION',
    head: 'Film Contest',
    image: '/Images/cam3.avif',
    bgColor: 'bg-white',
  },
  {
    tittle: '\n EMULSION',
    head: 'Mobile Photograph',
    image: '/Images/cam5.jpg', // Make sure to provide a valid image path
    bgColor: 'bg-white',
  },
];
  ...
  return (
    <div className='bg-[#150F24] min-h-screen'>
      ...
      <div className='text-center text-white mt-24'>
          ...
          <h1 className='text-3xl font-bold '>EMULSION</h1>
      </div>
